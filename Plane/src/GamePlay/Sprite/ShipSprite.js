...
//        事件穿透，触屏事件
    ...
    shoot : function(dt){
        ...
        var leftBullet = BulletSprite.getOrCreateBullet(Const.BULLET_SPEED.SHIP, "W1.png", Const.ENEMY_ATTACK_MODE.NORMAL, 3000, Const.UNIT_TAG.PLAYER_BULLET);
        leftBullet.x = this.x - 13;
        leftBullet.y = this.y + 3 + this.height * 0.3;

        var rightBullet = BulletSprite.getOrCreateBullet(Const.BULLET_SPEED.SHIP, "W1.png", Const.ENEMY_ATTACK_MODE.NORMAL, 3000, Const.UNIT_TAG.PLAYER_BULLET);
